...
- Key Project Folders
  - **moo-ds**: `moo-ds/` - Design system 
  - **moo-app**: `moo-app/` - Application framework library
  - **moo-icons**: `moo-icons/` - An icon library with React JS support
  - **storybook**: `storybook/` - Documentation for the component library
