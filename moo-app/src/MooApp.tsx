...
import { faArrowRightFromBracket, faCheck, faChevronDown, faChevronLeft, faEllipsisVertical, faFilter, faMoon, faSun, faTimesCircle, faXmark } from "@fortawesome/free-solid-svg-icons";
import { library } from "@fortawesome/fontawesome-svg-core";
import { type AxiosInstance } from "axios";


/* Icons the framework's own chrome draws. A consumer registers what its pages
   ...
   nothing. */
library.add(faArrowRightFromBracket, faCheck, faChevronDown, faChevronLeft, faEllipsisVertical, faFilter, faMoon, faSun, faTimesCircle, faXmark);
